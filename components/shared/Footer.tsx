...
export const Footer = () => {
  return (
    <footer className=" text-gray3 border-gray2 container-space md:pb-[100px] pb-[50px]">
      ...
      <p className="pt-[10px] pb-[20px] text-center md:text-[20px] text-[10px]">
        Connect with me{" "}
        <a href="mailto:ejiroasiuwhu10@gmail.com " className="underline">ejiroasiuwhu10@gmail.com</a>
      </p>
      <div className="border-t border-solid font-medium md:text-[16px] text-[8px] flex items-center justify-between md:pt-[50px]  pt-[10px]   ">
        <div>
          ...
          >
            Design with
            <a className=" inline-flex md:w-[15px] w-[8px] mx-[6px] cursor-pointer" 
